 ...
 */
public class StatisticianScoringRecord implements Serializable {
	private static final long serialVersionUID = 1L;
	
	//主键ID
	private Integer id;
	//月打分记录ID
	 @Excel(name = "月打分记录ID",isImportField="true")
	...
	//统计员手机号码
	 @Excel(name = "统计员手机号码",isImportField="true")
	private String mobilePhone;
	//得分规则ID
	 @Excel(name = "得分规则ID",isImportField="true")
	...
	//得分类型
	 @Excel(name = "得分类型",replace={"扣分_0","加分_1"},isImportField="true")
