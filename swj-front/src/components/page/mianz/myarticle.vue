    ...
    <div class="table">
        ...
        <el-table :data="tableData" border style="width: 100%" v-loading.body="loading" @selection-change="selsChange">
            ...
            <el-table-column label="操作" fixed="right" width="180">
                <template scope="scope">
                    <el-button size="small" v-if="scope.row.status==2" @click="handleQuery(scope.$index, scope.row)">查看</el-button>
                    <el-button size="small" v-if="scope.row.status!=2" @click="handleEdit(scope.$index, scope.row)">编辑</el-button>
                    <el-button size="small" v-if="scope.row.status!=2" type="danger" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="formTittle" v-model="formVisible" :close-on-click-modal="false" size="big">
                ...
                <el-row>
                    <el-col :span='12'>
                        <el-form-item label="内容类型" prop="articleType">
                            <el-select :disabled="formReadOnly" v-model="subform.articleType" placeholder="请选择内容类型">
                                <v-yvoption groupName="articleType"></v-yvoption>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="文章种类" prop="articleCategorys">
                            <el-cascader :options="dataTree" :show-all-levels="false" :props="defaultProps" expand-trigger="hover" :disabled="formReadOnly" v-model="subform.articleCategorys"></el-cascader>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="是否公开" prop="isPublic">
                            <el-select :disabled="formReadOnly" v-model="subform.isPublic" placeholder="请选择是否公开">
                    ...
                    <el-col :span='12'>
                        <el-form-item label="部门ID" prop="departIds">
                            <el-select :readonly="formReadOnly" v-model="subform.departIds" placeholder="请选择部门" disabled>
                                <v-yvoption tableName="department" label="departname" value='id'></v-yvoption>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="状态" prop="status">
                            <el-select :disabled="formReadOnly" v-model="subform.status" placeholder="请选择状态 ">
                                <v-yvoption groupName="articleStatus" :disabledIds="disabledIds"></v-yvoption>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="置顶级别" prop="topLevel">
                            <el-input :readonly="formReadOnly" v-model="subform.topLevel" :maxlength=20 auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span='12'>
                        <el-form-item label="创建人" prop="createBy">
                            <el-select :readonly="formReadOnly" v-model="subform.createBy" placeholder="请选择创建人" disabled>
                                <v-yvoption tableName="user" label="nick_name" value='id'></v-yvoption>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="创建时间" prop="createTime">
                            <el-date-picker type="datetime" placeholder="选择日期" :readonly="formReadOnly" v-model="subform.createTime" disabled></el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="发表日期" prop="publishTime">
                            <el-date-picker type="datetime" placeholder="选择日期" :readonly="formReadOnly" v-model="subform.publishTime" disabled></el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="一级审核人" prop="audit1By">
                            <el-select disabled :readonly="formReadOnly" v-model="subform.audit1By" placeholder="请选择一级审核人">
                                <v-yvoption tableName="user" label="nick_name" value='id'></v-yvoption>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="一级审核时间" prop="audit1Time">
                            <el-date-picker type="datetime" placeholder="选择日期" :readonly="formReadOnly" v-model="subform.audit1Time" disabled></el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span='12'>
                        <el-form-item label="二级审核人" prop="audit2By">
                            <el-select disabled :readonly="formReadOnly" v-model="subform.audit2By" placeholder="请选择二级审核人">
                                <v-yvoption tableName="user" label="nick_name" value='id'></v-yvoption>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="二级审核时间" prop="audit2Time">
                            <el-date-picker type="datetime" placeholder="选择日期" :readonly="formReadOnly" v-model="subform.audit2Time" disabled></el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span='12'>
                        <el-form-item label="三级审核人" prop="audit3By">
                            <el-select disabled :readonly="formReadOnly" v-model="subform.audit3By" placeholder="请选择三级审核人">
                                <v-yvoption tableName="user" label="nick_name" value='id'></v-yvoption>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="三级审核时间" prop="audit3Time">
                            <el-date-picker type="datetime" placeholder="选择日期" :readonly="formReadOnly" v-model="subform.audit3Time" disabled></el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span='24'>
                        <el-form-item label="备注" prop="remark">
                            <el-input type="textarea" :maxlength=200 :readonly="formReadOnly" v-model="subform.remark" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span='12'>
                        <el-form-item label="内容标题" prop="title">
                            <el-input :readonly="formReadOnly" v-model="subform.title" :maxlength=30 auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span='12'>
                        <el-form-item label="内容作者" prop="author">
                            <el-input :readonly="formReadOnly" v-model="subform.author" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span='24'>
                        <el-form-item label="简介" prop="breif">
                            <el-input type="textarea" :readonly="formReadOnly" v-model="subform.breif" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span='24'>
                        <el-form-item label="内容" prop="content">
                            <!-- <quill-editor ref="myTextEditor" :readonly="formReadOnly" v-model="subform.content" :config="editorOption"></quill-editor> -->
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" v-if="subform.status!=2" @click.native="formSubmit" :loading="formLoading">提交</el-button>
            </div>
        </el-dialog>
    </div>
</template>
                ...
                this.$refs["queryform"].validate((valid) => {
                    if (valid) {
                        ...
                        let params = {
                            ...
                            createBy:user.id,//我的文章只能管理我发的文章
                        }
