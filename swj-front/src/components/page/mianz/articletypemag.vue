    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>文章类型管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
		<!--工具条-->
        ...
        <el-table :data="tableData" border style="width: 100%" v-loading.body="loading" @selection-change="selsChange">
            <el-table-column type="selection" width="70"></el-table-column>
             ...
             <el-table-column prop="indexId" label="索引位"></el-table-column>
                ...
                <el-col :span='12'>
                    ...
                    <el-col :span='12'>
                        <el-form-item label="索引位" prop="indexId">
                            <el-input v-model="subform.indexId" auto-complete="off"></el-input>
                        </el-form-item>
                 </el-col>
                    <el-col :span='12'>
            ...
            formSubmit() {
                this.$refs["subform"].validate((valid) => {
                    if (valid) {
                        ...
                        if (param.id != "") {
                            editArticleType(param).then((res) => {
                            ...
                            createArticleType(param).then((res) => {
                                this.formLoading = false;
                                if (res.data.code == '000000') {
                                    this.$message.success("保存成功");
                                    this.formVisible = false;
