    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>数据类型管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
		<!--工具条-->
        ...
        <el-table :data="tableData" border style="width: 100%" v-loading.body="loading" @selection-change="selsChange">
            <el-table-column type="selection" width="70"></el-table-column>
             ...
             <el-table-column prop="typeName" label="名称" sortable></el-table-column>
             <el-table-column prop="typeCode" label="代码" sortable></el-table-column>
             <el-table-column prop="typeGroupId" label="类型组ID" sortable></el-table-column>
             <el-table-column prop="status" label="" sortable></el-table-column>
            ...
            <el-form :model="subform" label-width="90px" :rules="formRules" ref="subform">
                ...
                <el-col :span='12'>
                        <el-form-item label="名称" prop="typeName">
                            <el-input v-model="subform.typeName" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                <el-col :span='12'>
                        <el-form-item label="代码" prop="typeCode">
                            <el-input v-model="subform.typeCode" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                <el-col :span='12'>
                        <el-form-item label="类型组ID" prop="typeGroupId">
                            <el-input v-model="subform.typeGroupId" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                <el-col :span='12'>
