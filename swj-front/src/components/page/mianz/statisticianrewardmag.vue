    ...
    <div class="table">
        ...
        <el-table :data="tableData" border style="width: 100%" v-loading.body="loading" @selection-change="selsChange">
            <el-table-column type="selection" width="70"></el-table-column>
             ...
             <el-table-column prop="amount" label="姓名" sortable></el-table-column>
             <el-table-column prop="perPointValue" label="联系电话" sortable></el-table-column>
        ...
        <el-dialog :title="formTittle" v-model="formVisible" :close-on-click-modal="false" size="small">
            <el-form :model="subform" label-width="90px" :rules="formRules" ref="subform">
                ...
                <el-col :span='12'>
                        <el-form-item label="姓名" prop="amount">
                            <el-input v-model="subform.amount" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                <el-col :span='12'>
                        <el-form-item label="联系电话" prop="perPointValue">
