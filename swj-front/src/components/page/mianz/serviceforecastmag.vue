    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>服务业企业数据预测管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
		<!--工具条-->
        ...
        <el-table :data="tableData" border style="width: 100%" v-loading.body="loading" @selection-change="selsChange">
            <el-table-column type="selection" width="70"></el-table-column>
             ...
             <el-table-column prop="defineId" width='240' label="服务业定义ID">
                <template scope="scope">
                    <v-yvtableoption tableName="service_define" label="index_name" value='id' :trueValue="scope.row.defineId"></v-yvtableoption>
                </template>
            </el-table-column>
            ...
            <el-form :model="subform" label-width="90px" :rules="formRules" ref="subform">
                ...
                <el-col :span='12'>
                        <el-form-item label="服务业定义ID" prop="defineId">
                            <el-select v-model="subform.defineId" placeholder="请选择服务业数据类型">
                                <v-yvoption tableName="service_define" label="index_name" value='id'></v-yvoption>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    </el-row>
                ...
                <el-col :span='12'>
                        <el-form-item label="1至本月累计金额" prop="currAmount">
                            <el-input v-model="subform.currAmount" auto-complete="off">
                                <template slot="append">千元</template>
                            </el-input>
                        </el-form-item>
                    </el-col>
                <el-col :span='12'>
                        <el-form-item label="1至本月增速" prop="currAmountRise">
                            <el-input v-model="subform.currAmountRise" auto-complete="off">
                ...
                <el-col :span='12'>
                        <el-form-item label="上年同期1至本月金额" prop="lastAmount">
                            <el-input v-model="subform.lastAmount" auto-complete="off">
                                <template slot="append">千元</template>
                            </el-input>
                        </el-form-item>
                    </el-col>
                <el-col :span='12'>
                        <el-form-item label="上年同期1至本月增速" prop="lastAmountRise">
                            <el-input v-model="subform.lastAmountRise" auto-complete="off">
                                <template slot="append">%</template>
                            </el-input>
                        </el-form-item>
                    </el-col>
                <el-col :span='12'>
                        <el-form-item label="当前主要问题" prop="problem">
                            <el-input type='textarea' :maxlength=200 v-model="subform.problem" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
                <el-col :span='12'>
                        <el-form-item label="拟采取措施" prop="solution">
                            <el-input type='textarea' :maxlength=200 v-model="subform.solution" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-col>
            </el-row>
            </el-form>
...
export default {
    data() {
            return {
                exportUrl: base+"/serviceForecasts/export",
                tableData: [],
                pageIndex: 1,
                pageSize: 10,
                totalCount: 0,
                ...
                formRules: {
                    ...
                    currAmountRise:[{validator:checkMoney, required: true,trigger: 'blur'}],
        ...
        methods: {
            getExportUrl(){
                this.exportUrl=base+"/serviceForecasts/export?id="+this.queryParam.id+"&year="+this.queryParam.year+"&month="+this.queryParam.month;
            },
