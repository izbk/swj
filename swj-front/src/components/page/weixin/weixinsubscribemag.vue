    ...
    <div class="table">
        ...
        <!-- <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true">
                ...
                <el-form-item label="欢迎语">
                    <el-input v-model="queryParam.name" :maxlength=30 auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="getWeixinSubscribeList">查询</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <el-table :data="tableData" border style="width: 100%" v-loading.body="loading" @selection-change="selsChange">
            <!-- <el-table-column type="selection" width="70"></el-table-column> -->
             ...
             <el-table-column prop="welcome" label="欢迎语"></el-table-column>
                ...
                <el-col :span='12'>
                    ...
                    <el-col :span='12'>
                        <el-form-item label="创建时间" prop="createTime">
                            <el-date-picker type="datetime" disabled placeholder="选择日期" v-model="subform.createTime"></el-date-picker>
                        </el-form-item>
                    </el-col>

                    <el-col :span='24'>
                        <el-form-item label="欢迎语" prop="welcome">
                            <el-input type="textarea" :maxlength=200 v-model="subform.welcome" auto-complete="off"></el-input>
                        </el-form-item>
                 </el-col>
            </el-row>
            </el-form>
...
<script>
import {
    createWeixinSubscribe,
    getWeixinSubscribeList,
    editWeixinSubscribe,
    delWeixinSubscribe,
    base
} from '../../../api/api';
...
export default {
    data() {
            return {
                ...
                formRules: {
                    welcome:[{message:"该值不能为空", required: true,trigger: 'blur'}],
                },
                formLoading: false
            }
        },
        ...
        methods: {
            ...
            handleDelete(index, row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    delWeixinSubscribe(param).then((res) => {
                        if (res.data.code == '000000') {
                            this.formVisible = false;
                            this.getWeixinSubscribeList();
            ...
            getWeixinSubscribeList() {
                ...
                getWeixinSubscribeList(params).then((res) => {
                    this.loading = false;
                    if (res.data.code == '000000') {
            ...
            formSubmit() {
                this.$refs["subform"].validate((valid) => {
                    if (valid) {
                        ...
                        if (param.id != "") {
                            editWeixinSubscribe(param).then((res) => {
                            ...
                            createWeixinSubscribe(param).then((res) => {
                                this.formLoading = false;
                                if (res.data.code == '000000') {
                                    this.$message.success("保存成功");
                                    this.formVisible = false;
